    ...
    @include("admin.sidebar")
     ...
     <div class="container">
      ...
      <div class="container" align="center" style="text-align:center; margin-top:35px">
        <h1 style="color:white; font-style:italic; font-family:broadway; font-size:32px; margin-top:30px; background-color:BROWN; padding:15px; margin-bottom:52px">REGISTER NEW SURVEYOR</h1>
...
<!-- <div style="border:3px solid red; padding:10px; border-radius:150px 10px 150px 10px">
      ...
      <form style="" class="form" action="{{url('upload_surveyors')}}" method="post" enctype="multipart/form-data">
          @csrf

        <div class="form-group">
          <label for="plan">SURCON NUMBER</label>
          <input style="color:tomato;" class="form-control" type="text" placeholder="Enter Surveyor's Surcon number" name="surcon" required>
        </div>
